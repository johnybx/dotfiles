...
btrfs subvolume create @home/jan/workspace/git
...
for f in "home" "home/jan" "home/jan/workspace" "home/jan/workspace/git" "home/jan/workspace/work" "root" "var" "var/cache" "var/log"  "snapshots"; do
    mkdir "$MOUNTPOINT"/$f
